...
namespace Models.Base
{
    ...
    {
		private static string connectionString = @"Data source=.;initial catalog=FRBA2018;Trusted_Connection=True;MultipleActiveResultSets=true;";
        //private static string connectionString = @"Data source=.;initial catalog=FRBA2018;user=;pass=";
